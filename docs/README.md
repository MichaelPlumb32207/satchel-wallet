...
[root README](../README.md). This folder holds the **nine living documents**,
...
| [USE_CASE_CATALOG.md](USE_CASE_CATALOG.md) | Every user-facing use case (`UC-###`) |
| [TEST_PLAN.md](TEST_PLAN.md) | Automated + manual test matrix (`TC-###` ↔ `UC-###`) |
...
**Protocol (every change):** implement → read/update all nine docs (even to
