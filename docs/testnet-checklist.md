...
touches wallet logic. Free coins: search "testnet4 faucet" (e.g.
mempool.space's faucet at https://mempool.space/testnet4/faucet, requires
login) and send to your Satchel practice-mode receive address.
